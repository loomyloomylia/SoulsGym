"""The SoulsGym environment for Margit, The Fell Omen.
...
world. The player starts with the [class_choice, perhaps vagabond?] base stats and the default starting weapons
without any upgrades. We do not allow shield blocking or two handing at this point, although this can easily
...
class IudexEnv(SoulsEnv):
    ...
    ENV_ID = "eldenring"
    BONFIRE = "Castleward Tunnel"
    ARENA_LIM_LOW = [-36.0, -32.0, -7.0, -3.1415]
    ARENA_LIM_HIGH = [19.0, -4, 0.0, 3.1415]
    CAM_SETUP_POSE = [0.378, 0.926, 0.0]
    MARGIT_MAX_HP = 4174  # When we are not in the region, the boss HP read can be incorrect
